...
int Simulation_ExcitationExterior(S4_Simulation *S, int n, const int *exg, const double *ex);
...
int Simulation_ExcitationDipole(S4_Simulation *S, const double k[2], const char *layer, const double pos[2], const double moment[6]);
